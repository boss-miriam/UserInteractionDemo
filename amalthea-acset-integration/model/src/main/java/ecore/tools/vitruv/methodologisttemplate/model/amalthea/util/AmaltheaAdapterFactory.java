/**
 */
package ecore.tools.vitruv.methodologisttemplate.model.amalthea.util;
...
public class AmaltheaAdapterFactory extends AdapterFactoryImpl
{
	...
	protected AmaltheaSwitch<Adapter> modelSwitch =
		new AmaltheaSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseProcess(ecore.tools.vitruv.methodologisttemplate.model.amalthea.Process object)
			{
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecore.tools.vitruv.methodologisttemplate.model.amalthea.ComponentContainer <em>Component Container</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruv.methodologisttemplate.model.amalthea.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruv.methodologisttemplate.model.amalthea.ISR <em>ISR</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link tools.vitruv.methodologisttemplate.model.amalthea.Task <em>Task</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
