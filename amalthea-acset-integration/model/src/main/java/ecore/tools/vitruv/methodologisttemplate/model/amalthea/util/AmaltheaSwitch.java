...
public class AmaltheaSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case AmaltheaPackage.COMPONENT_CONTAINER:
			{
			...
			{
        ecore.tools.vitruv.methodologisttemplate.model.amalthea.Process process = (ecore.tools.vitruv.methodologisttemplate.model.amalthea.Process)theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(ecore.tools.vitruv.methodologisttemplate.model.amalthea.Process object)
	{
		return null;
	}
