...
public class CreateAndRegisterRootComponentContainerRoutine extends AbstractRoutine {
  ...
  private static class Match extends AbstractRoutine.Match {
    ...
    public CreateAndRegisterRootComponentContainerRoutine.Match.RetrievedValues match(final ComponentContainer componentContainer) throws IOException {
      ...
      return new mir.routines.amalthea2ascet.CreateAndRegisterRootComponentContainerRoutine.Match.RetrievedValues();
    }
  }
  ...
  private static class Create extends AbstractRoutine.Create {
    ...
    public CreateAndRegisterRootComponentContainerRoutine.Create.CreatedValues createElements() {
      tools.vitruv.methodologisttemplate.model.model.AscetModule mRoot = createObject(() -> {
      	return tools.vitruv.methodologisttemplate.model.model.impl.ModelFactoryImpl.eINSTANCE.createAscetModule();
      });
  ...
  protected boolean executeRoutine() throws IOException {
    ...
    retrievedValues = new mir.routines.amalthea2ascet.CreateAndRegisterRootComponentContainerRoutine.Match(getExecutionState()).match(inputValues.componentContainer);
    if (retrievedValues == null) {
    	return false;
    }
    createdValues = new mir.routines.amalthea2ascet.CreateAndRegisterRootComponentContainerRoutine.Create(getExecutionState()).createElements();
    new mir.routines.amalthea2ascet.CreateAndRegisterRootComponentContainerRoutine.Update(getExecutionState()).updateModels(inputValues.componentContainer, createdValues.mRoot, getRoutinesFacade());
    return true;
  }
}
